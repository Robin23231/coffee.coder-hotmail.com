...
public class tour_ReveiwAdapter extends ArrayAdapter<BaseCompanyInfo> {

    List<String> l;
    Context mContext;
    public tour_ReveiwAdapter(@NonNull Context context, List<BaseCompanyInfo> object) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_review.setText(getItem(position).gettour_review_content());
        tv_review_detail.setText(getItem(position).getusername());
        review_rating.setRating(getItem(position).gettour_review_stars());
        return convertView;
    }
}
